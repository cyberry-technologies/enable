...
az aks delete --resource-group enableResourceGroupEastUS --name enable --yes --no-wait
...
az group delete --name enableResourceGroupEastUS --yes --no-wait
echo -e "\n\n${PURPLE}[Cyberry Enable Setup Tool]:${NC} ${GREEN}Deleted resource group enableResourceGroupEastUS${NC}"
