...
echo -e "\n\n${PURPLE}[Cyberry Enable Setup Tool]:${NC} ${YELLOW}Trying to commit and push change to main branch to deploy...${NC}"
git add .
git commit -m "Setup AKS cluster"
git push origin main
echo -e "\n\n${PURPLE}[Cyberry Enable Setup Tool]:${NC} ${GREEN}Done committing and pushing change to main branch to deploy.${NC}"
